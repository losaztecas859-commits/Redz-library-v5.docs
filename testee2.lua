...
local redzlib = {
	...
	["Color Hub 1"] = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 5, 10))     -- Preto levemente cinza embaixo
	}),
	
	["Color Hub 2"] = Color3.fromRGB(10, 10, 10),   -- Fundo das tabs preto escuro
	["Color Stroke"] = Color3.fromRGB(30, 30, 30),  -- Stroke sutil, quase invisível
	
	["Color Theme"] = Color3.fromRGB(120, 120, 120),   -- Azul escuro pros detalhes
...
Green = {
    ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(120, 220, 120)),  -- Verde claro no topo
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(60, 150, 60))    -- Verde mais escuro embaixo
    }),
    
    ["Color Hub 2"] = Color3.fromRGB(30, 90, 30),   -- Fundo das tabs / conteúdo em verde escuro
    ["Color Stroke"] = Color3.fromRGB(20, 60, 20),  -- Stroke sutil, verde bem escuro
    
    ["Color Theme"] = Color3.fromRGB(80, 180, 80),  -- Verde médio pros detalhes / highlights
    
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Texto branco
    ["Color Dark Text"] = Color3.fromRGB(200, 255, 200) -- Texto secundário verde clarinho
},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
